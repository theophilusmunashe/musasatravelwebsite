...
const accommodationDataMap: { [key: string]: any } = {
  "luxury-safari-lodge": {
    ...
    reviews: 328,
    description:
      "Experience the ultimate African safari in our exclusive luxury lodge, nestled on the banks of the Zambezi River with stunning views of the iconic Victoria Falls. Each suite features floor-to-ceiling windows, private infinity pools, and personalized service from our dedicated concierge team.",
    amenities: [
      "Free WiFi",
  ...
  "boutique-coastal-retreat": {
    ...
    reviews: 287,
    description:
      "Discover the epitome of coastal elegance at our boutique retreat, perched on the cliffs overlooking the Atlantic Ocean. Our intimate 12-suite property offers unmatched privacy and personalized experiences.",
    amenities: [
      "Free WiFi",
      "Complimentary Breakfast",
      "Fine Dining Restaurant",
  ...
  "mountain-view-cabin": {
    ...
    reviews: 156,
    description:
      "Retreat to our rustic yet luxurious mountain cabin, where nature meets comfort. Surrounded by the majestic Drakensberg Mountains, this intimate hideaway offers stunning vistas and access to world-class hiking trails.",
    amenities: [
      "Free WiFi",
      "Complimentary Breakfast",
      "Fine Dining Restaurant",
  ...
  "safari-tent-camp": {
    ...
    reviews: 201,
    description:
      "Experience authentic African safari in our luxury tent camp, offering the thrill of close-to-nature experiences combined with high-end comfort.",
    amenities: [
      "Free WiFi",
      "Complimentary Breakfast",
      "Fine Dining Restaurant",
  ...
  "beachfront-villa": {
    ...
    reviews: 189,
    description:
      "Your private beachfront paradise awaits at our exclusive villa, complete with direct beach access, infinity pool, and sunset views over the Atlantic.",
    amenities: [
      "Free WiFi",
      "Complimentary Breakfast",
      "Fine Dining Restaurant",
  ...
  "eco-lodge": {
    ...
    reviews: 234,
    description:
      "Embrace sustainable luxury at our award-winning eco lodge, committed to environmental conservation and community development.",
    amenities: [
      "Free WiFi",
      "Complimentary Breakfast",
      "Fine Dining Restaurant",
  ...
  "river-view-cottage": {
    ...
    reviews: 142,
    description:
      "Charming riverside cottage offering serene views of the Zambezi River and proximity to adventure activities.",
    amenities: [
      "Free WiFi",
      "Complimentary Breakfast",
      "Fine Dining Restaurant",
...
export default function AccommodationDetailClient({ params }: Props) {
